...
if '%player%'=='suggest' goto suggesta
goto players
:name
cls
set name=
...
if '%country%'=='germany' goto enemy4
if '%country%'=='Japan' goto enemy5
if '%country%'=='japan' goto enemy5
if '%country%'=='Turkey' goto enemy6
if '%country%'=='turkey' goto enemy6
if '%country%'=='France' goto enemy7
if '%country%'=='france' goto enemy7
goto countr
rem Countrys
:enemy2
...
echo   -Japan, France & Turkey added
echo   -Gameplay fix
echo   -Overlay edited
